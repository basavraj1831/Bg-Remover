  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      <div>
        ...
        <p className='my-6 text-[15px] text-gray-500'>Effortlessly erase photo backgrounds, whether it’s a busy event scene or delicate details in festive photos.<br className='max-md:hidden'/> Instantly download, share across platforms, or refine further with ease.</p>
        <div>
